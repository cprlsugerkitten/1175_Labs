...
# interpreter = tf.Interpreter(model_path="model_video.tflite")
# interpreter.allocate_tensors()

# Load your trained model with TensorFlow Lite runtime
interpreter = Interpreter(model_path="model_video.tflite")
interpreter.allocate_tensors()
...
def main():
    ...
    while True:
        ...
        dance_move = capture_frames(expected_class)
        print(f"You tried to {dance_move} when you should've {expected_class}.")
